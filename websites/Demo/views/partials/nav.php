                            ...
                            <div class="relative ml-3">
                                ...
                                <button
                                    ...
                                    <?php else : ?>
                                        ...
                                        <a href="/login" class="<?= urlIs('/login') ? "rounded-md bg-gray-950/50 px-3 py-2 text-sm font-medium text-white" : "rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white"?>">Login</a>
                                    <?php endif; ?>
                            </div>
                            ...
                            <?php if ($_SESSION['user'] ?? false) : ?>
                                <div class="ml-3">
                                    <form action="/session" method="POST">
                                        ...
                                        <button class="rounded-md px-3 py-2 text-sm text-gray-300 hover:bg-white/5 hover:text-white">Logout</button>
                                    </form>
                                </div>
                                <?php endif; ?>
                            </div>
